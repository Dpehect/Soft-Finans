    ...
    <div className="relative inline-block" ref={dropdownRef}>
      <button
        className={`px-2 py-0.5 text-xs font-bold rounded border transition-colors ${
          value.enabled
            ? "bg-terminal-accent border-terminal-accent text-white shadow-xs"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-1 w-64 bg-terminal-panel border border-terminal-border rounded-xl shadow-xl z-50 p-3 text-xs text-terminal-text">
          ...
          <div className="space-y-2">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                ...
                className="rounded border-terminal-border bg-terminal-bg text-terminal-accent focus:ring-terminal-accent/30"
              />
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-terminal-bg border border-terminal-border rounded px-1.5 py-1 text-xs focus:ring-terminal-accent/30"
              >
